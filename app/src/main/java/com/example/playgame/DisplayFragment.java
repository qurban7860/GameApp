...
public class DisplayFragment extends Fragment {
    ...
    private ResultAdapter testResultAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        testResultAdapter = new ResultAdapter(getActivity(), testResultList);
    ...
    private void retrieveData() {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                ...
                Result testResult = new Result(id,questions, selections, correctAnswers, score);
